...
class sql_write_excel (object):
    def __init__(self,host,port,Table_Names,rw_type):
    ...
    def write_to_excel_all(self):
        ...
        for i in range(len(self.rwType_info)):
            ...
            #statement = self.table_n + 'AND Readwrite_type =' + rw
            SQL_Sentence = 'select'+' '+ '*' +' '+'from'+' '+ self.table_n
            ...
            cur.execute(SQL_Sentence)
            with open(Excel_filename + ".csv" ,"a+") as csv_file:
